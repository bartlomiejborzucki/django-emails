...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.original_key'
        db.add_column('emails_email', 'original_key',
                      self.gf('django.db.models.fields.CharField')(default='0000000000000000000000000000000000000000', max_length=60, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Email.original_key'
        db.delete_column('emails_email', 'original_key')
    ...
    models = {
        ...
        'emails.email': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'0000000000000000000000000000000000000000'", 'max_length': '60', 'db_index': 'True'}),
            'original_key': ('django.db.models.fields.CharField', [], {'default': "'0000000000000000000000000000000000000000'", 'max_length': '60', 'db_index': 'True'}),
