...
class EmailSendTestCase(TestCase):
    ...
    def test_emails_exceptions(self):
        ...
        self.assertRaises(Diffrent_emails, send_email, self.request, topic, template="emails/emails/base_email.html",
                          user=self.user, email="test81@example.com", data_email={}, is_send_now=False)
        self.assertRaises(Email_is_empty, send_email, self.request, topic, template="emails/emails/base_email.html",
                          data_email={}, is_send_now=False)
